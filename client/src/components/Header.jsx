  ...
  return (
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        text-gray-700'>
            Where <span className='text-primary'>Ideas</span> Find <br />a Voice.

        </h1>
        <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs
        text-gray-500'>
            From one word to a thousand, every story has a beginning. This is where yours and mine take shape — 
            in a space made for sharing and inspiring
        </p>
