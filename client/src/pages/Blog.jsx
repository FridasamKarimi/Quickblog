  ...
  return data ? (
    <div className='relative'>
     ...
     <div className='text-center mt-20 text-gray-600'>
      <p className='text-primary py-4 font-medium'>Published on: {Moment(data.publishedOn).format('MMMM Do YYYY')}</p>
      ...
      border-primary/35 bg-primary/5 font-medium text-primary'>Fridasam Karimi</p>
     </div>
     ...
     <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
      ...
      <div className='max-w-3xl mx-auto mb-10'>
        ...
        max-w-lg'>
          ...
          <textarea onChange={(e) => setContent(e.target.value)} value={content} placeholder='Comment' required className='w-full
          p-2 border border-gray-300 rounded outline-none h-48'></textarea>

          <button type='submit' className='bg-primary text-white rounded p-2
          px-8 hover:scale-105 transition-all cursor-pointer '>
            Submit
          </button>
